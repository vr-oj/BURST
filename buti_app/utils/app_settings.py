# buti_app/utils/app_settings.py
import json
import os
import logging
...
SETTINGS_FILE = os.path.join(APP_CONFIG_DIR, "buti_settings.json")
...
SETTING_MIRROR_HORIZONTAL = "mirror_horizontal"
SETTING_MIRROR_VERTICAL = "mirror_vertical"
SETTING_COMPLETION_SOUND = "recording_completion_sound"
